What each of the scripts in this folder does

- 0-current_working_directory: prints the current working directory
- 1-listit: lists the contents of current directory
...
- 13-symbolic_link: creates a symbolic link to /bin/ls, named __ls__ in the working dir
